...
The expression $\beta_0 + \beta_1 x_1 + \beta_2 x_2 + u_{0j}$ is a linear function of the independent variables. In order make a linear prediction appropriate, we take the logarithm of the odds, which provides the equation for logistic regression. 
...
Through a bit of algebra, we can manipulate this equation to provide more intuitive results. 
