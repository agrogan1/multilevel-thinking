...
The odds provide a convenient way to understand the relationship of independent variables of interest with a dichotomous outcome. At the same time, it is often forgotten that the odds are not the same as probabilities, and changes in odds are not the same as changes in probabilities (@tbl-probabilities-odds). 
