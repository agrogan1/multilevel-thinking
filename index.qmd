...
The book started out as a set of notes on *things I only get to discuss during breaks, or after class, or during office hours* in my class on *Multilevel and Longitudinal Modeling*, and grew from that set of notes into a more general introduction to multilevel modeling. My aim is to provide an intuitive introduction to multilevel modeling. 
