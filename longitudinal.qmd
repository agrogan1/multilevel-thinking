...
`mixed outcome t warmth physical_punishment HDI || country: warmth || id: t`
...
* Multilevel Model: `mixed outcome t warmth physical_punishment HDI || id:`
* Fixed Effects Model: `xtreg outcome t warmth physical_punishment HDI, i(id) fe`
...
`mixed outcome t warmth mean_warmth physical_punishment HDI || id:`
