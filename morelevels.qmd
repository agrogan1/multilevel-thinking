...
Let us consider scenarios in which it is appropriate to estimate models with four levels, or with levels that are cross-classified. Both the World Bank (**CITATION**), and the United Nations (**CITATION**) divide the countries of the world into a number of regions (**COUNTRYCODE CITATION**). Thus, we can imagine adding a few regional groupings to our data. 
...
**More general formula according to Stata Corporation** (**Do ICC's proliferate???**)
