...
gt(conceptualframework) %>% 
  cols_label(
    conceptuallevel = "conceptual level",
    statisticallevel1 = "statistical level 1",
    statisticallevel2 = "statistical level 2"
  ) %>% 
  tab_header(
    title = md("Variables and Processes"),
    subtitle = "at Multiple Levels") 
