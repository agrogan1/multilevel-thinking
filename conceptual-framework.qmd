...
* $\color{black}\overline{\text{community collective efficacy}_{.j}}$ or $\color{black}\overline{\text{community safety}_{.j}}$ would be variables that *conceptually* come from Level 2 responses, but are *statistically* aggregated to Level 2.
