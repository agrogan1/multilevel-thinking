...
The idea of this book is that a deeper study of multilevel modeling can result in an advanced "quantitative literacy" [@Wiest2007], \index{quantitative literacy} "quantitative criticalism" [@Scharrer2021], \index{quantitative criticalism} or "principled argument" [@Abelson1995], that is appropriate for drawing accurate conclusions from multilevel data. 
