...
3. Adjudicate the *complex multivariate relationships* of risk factors, protective factors and outcomes. [^multivariate]

[^multivariate]: In @sec-Simpsons, I consider the way issues of omitted variables--an often underappreciated issue--contribute to the complexity of estimating multivariate relationships in all quantitative work.
