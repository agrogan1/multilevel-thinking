...
The idea of this document is that a deeper study of multilevel modeling can result in an advanced "quantitative literacy" [@Wiest2007], "quantitative criticalism" [@Scharrer2021], or "principled argument" [@Abelson1995], that is appropriate for drawing accurate conclusions from multilevel data. 
...
I ground this presentation in research that we have conducted on parenting and child development in international context [@Grogan-Kaylor2021; @WardA; @WardC; @Ward2023; @Pace2019; @Ma2022]. For the presentation in this document, I use simulated data on these issues.
