...
> "Listening to the world. Well, I did that, and I still do it. I still do it." [@Oliver2015]
...
3. Adjudicate the *complex multivariate relationships* of risk factors, protective factors and outcomes, while controlling for possible confounding variables, contextual variables, or background variables. [^multivariate]

[^multivariate]: In @sec-Simpsons, I consider the way issues of omitted variables--an often under-appreciated issue--contribute to the complexity of estimating multivariate relationships in all quantitative work.
