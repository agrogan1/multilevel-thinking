...
Similarly, the Islamic scientist @Alhazen_2023, often seen as one of the first exponents of scientific, thinking, described the scientific method in a text from 1000 A.D. The language is unfortunately gendered, which can perhaps be understood given the era of the writing.
