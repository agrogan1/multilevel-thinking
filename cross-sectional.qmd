...
$$\begin{gather} \text{outcome}_{ij} = \beta_0 + \beta_1 \text{parental warmth}_{ij} + \\ \beta_2 \text{physical punishment}_{ij} + \beta_3 \text{group}_{ij} + \\ \beta_4 \text{HDI}_{j} + \\ u_{0j} + u_{1j} \times \text{parental warmth} + e_{ij} \end{gather}$$ {#eq-MLMsubstantive}
...
$$\begin{gather} \text{outcome}_{ij} = \beta_0 + \beta_1 \text{parental warmth}_{ij} + \\ \beta_2 \text{physical punishment}_{ij} + \beta_3 \text{group}_{ij} + \\ \beta_4 \text{HDI}_{j} + \\ u_{0j} + u_{1j} \times \text{parental warmth} + e_{ij} \end{gather}$$ {#eq-MLMsubstantive2}
...
| $var(w_{0j}) \text{ if } x = w_{0j} + e_{ij}$[^w] | What is the country specific variation in the value of x? | 
| Dependent Variable    | 
