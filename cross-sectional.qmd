...
The idea that group level and individual level relationships must be the same [@FIREBAUGH20014023] has been termed the "ecological fallacy". \index{ecological fallacy}
...
Even less common is to examine *variation* itself as an outcome [@Burkner2018]. \inde{variation as an outcome}
